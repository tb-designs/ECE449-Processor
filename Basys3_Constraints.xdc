...
##Pmod Header JB
##Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports {in_port[2]}];					
	set_property IOSTANDARD LVCMOS33 [get_ports {in_port[2]}];
##Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {in_port[3]}];					
	set_property IOSTANDARD LVCMOS33 [get_ports {in_port[3]}];
##Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {in_port[4]}];					
	set_property IOSTANDARD LVCMOS33 [get_ports {in_port[4]}];
##Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {in_port[5]}];					
	set_property IOSTANDARD LVCMOS33 [get_ports {in_port[5]}];
##Sch name = JB7
set_property PACKAGE_PIN A15 [get_ports {in_port[6]}];					
	set_property IOSTANDARD LVCMOS33 [get_ports {in_port[6]}];
##Sch name = JB8
set_property PACKAGE_PIN A17 [get_ports {in_port[7]}];					
	set_property IOSTANDARD LVCMOS33 [get_ports {in_port[7]}];
##Sch name = JB9
set_property PACKAGE_PIN C15 [get_ports {in_port[8]}];					
	set_property IOSTANDARD LVCMOS33 [get_ports {in_port[8]}];
##Sch name = JB10 
set_property PACKAGE_PIN C16 [get_ports {in_port[9]}];		
...
##Sch name = JC9
set_property PACKAGE_PIN P17 [get_ports {in_port[0]}];					
	set_property IOSTANDARD LVCMOS33 [get_ports {in_port[0]}];
##Sch name = JC10
set_property PACKAGE_PIN R18 [get_ports {in_port[1]}];					
